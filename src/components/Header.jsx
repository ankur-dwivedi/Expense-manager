...
function Header() {
  return (
    ...
    <div className="container d-flex flex-column flex-md-row justify-content-between">
      ...
      <NavLink className="py-2 d-none d-md-inline-block" to="#">Add Expence</NavLink>
      <NavLink className="py-2 d-none d-md-inline-block" to="#">Create Category</NavLink>
      <NavLink className="py-2 d-none d-md-inline-block" to="#">All Expence</NavLink>
      <NavLink className="py-2 d-none d-md-inline-block" to="#">All Category</NavLink>
      <NavLink className="py-2 d-none d-md-inline-block" to="#">Logout</NavLink>
    </div>
  </nav>
